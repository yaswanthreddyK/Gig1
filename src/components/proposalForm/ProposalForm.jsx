    ...
    <div className='proposal-flex-direction'>
      ...
      <FormControl fullWidth margin="normal">
        ...
        <label htmlFor="upload-resume">
          <Button variant="contained" component="span" sx={{backgroundColor: "#25ae81",'&:hover': {backgroundColor: "#25ae81"}}}>
            Upload Resume
          </Button>
        </label>
      </FormControl>
      ...
      <div className="submit-button ">
        <Button variant="contained" onClick={handleSubmit} sx={{backgroundColor: "#25ae81", '&:hover': {backgroundColor: "#25ae81"}}}>Submit</Button>
      </div>
    </div>
  );
}
