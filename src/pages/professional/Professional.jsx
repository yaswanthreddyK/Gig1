...
const Professional = () => {
  ...
  const profile = {
    ...
    portfolioProjects: [
      { title: 'E-commerce Website', description: 'Developed an e-commerce website using MERN stack (MongoDB, Express.js, React.js, Node.js). Implemented user authentication, product listing, shopping cart functionality, and payment integration using Stripe.', images: ['../../../public/img/ecommerce.jpg'] },
      { title: 'Social Media Platform', description: 'Created a social media platform from scratch using MEAN stack (MongoDB, Express.js, Angular, Node.js). Implemented features such as user registration, profile management, post creation, like/comment functionality, and real-time notifications using Socket.io.', images: ['../../../public/img/ecommerce.jpg', '../../../public/img/ecommerce.jpg']  },
    ],
    workExperience: [
    ...
    <div className='professional-view-profile'>
      <div>
        <Grid container spacing={2} sx={{backgroundColor: "white"}}>
          <Grid item xs={12} md={4} sx={{borderRight: "1px solid #e5e5e5"}} className='profile-card'>
            <Card className={classes.card}>
              <CardHeader
                avatar={<Avatar alt="Profile Picture" src="../../../public/img/man.png" className={classes.avatar} />}
                title={profile.name}
